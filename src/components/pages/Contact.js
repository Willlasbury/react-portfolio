...
export default function Contact () {
    ...
    return (
        ...
        <form className="flex flex-col items-center p-5 border-2 border-gray-700 rounded-lg shadow-sm shadow-inner" onSubmit={handleSubmit}>
            ...
            <button className="mt-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 border border-blue-700 rounded">Submit</button>
        </form>
        </section>
    )
}